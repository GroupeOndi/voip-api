 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TerminalModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TerminalModel';
    ...
    public function setIden($iden)
    {
        if ((mb_strlen($iden) > 100)) {
            throw new \InvalidArgumentException('invalid length for $iden when calling TerminalModel., must be smaller than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TerminalModel., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TerminalModel., must be smaller than or equal to 500.');
        }
