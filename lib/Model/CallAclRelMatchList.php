...
/**
 * CallAclRelMatchList Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallAclRelMatchList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallAclRelMatchList';
    ...
    public function setPolicy($policy)
    {
        ...
        if ((mb_strlen($policy) > 25)) {
            throw new \InvalidArgumentException('invalid length for $policy when calling CallAclRelMatchList., must be smaller than or equal to 25.');
        }
