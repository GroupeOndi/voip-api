 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserUpdateMyProfile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'User-updateMyProfile';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UserUpdateMyProfile., must be smaller than or equal to 100.');
        }
    ...
    public function setPass($pass)
    {
        if (!is_null($pass) && (mb_strlen($pass) > 80)) {
            throw new \InvalidArgumentException('invalid length for $pass when calling UserUpdateMyProfile., must be smaller than or equal to 80.');
        }
    ...
    public function setLastname($lastname)
    {
        if ((mb_strlen($lastname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling UserUpdateMyProfile., must be smaller than or equal to 100.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserUpdateMyProfile., must be smaller than or equal to 100.');
        }
    ...
    public function setMaxCalls($max_calls)
    {
        ...
        if (($max_calls < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_calls when calling UserUpdateMyProfile., must be bigger than or equal to 0.');
        }
