 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallAclRelMatchListDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallAclRelMatchList-detailed';
    ...
    public function setPolicy($policy)
    {
        ...
        if ((mb_strlen($policy) > 25)) {
            throw new \InvalidArgumentException('invalid length for $policy when calling CallAclRelMatchListDetailed., must be smaller than or equal to 25.');
        }
