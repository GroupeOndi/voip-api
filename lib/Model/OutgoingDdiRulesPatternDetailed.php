...
/**
 * OutgoingDdiRulesPatternDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OutgoingDdiRulesPatternDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutgoingDdiRulesPattern-detailed';
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 20)) {
            throw new \InvalidArgumentException('invalid length for $type when calling OutgoingDdiRulesPatternDetailed., must be smaller than or equal to 20.');
        }
    ...
    public function setPrefix($prefix)
    {
        if (!is_null($prefix) && (mb_strlen($prefix) > 10)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling OutgoingDdiRulesPatternDetailed., must be smaller than or equal to 10.');
        }
    ...
    public function setAction($action)
    {
        ...
        if ((mb_strlen($action) > 10)) {
            throw new \InvalidArgumentException('invalid length for $action when calling OutgoingDdiRulesPatternDetailed., must be smaller than or equal to 10.');
        }
