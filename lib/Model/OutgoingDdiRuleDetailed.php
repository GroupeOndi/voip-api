 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OutgoingDdiRuleDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutgoingDdiRule-detailed';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OutgoingDdiRuleDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setDefaultAction($default_action)
    {
        ...
        if ((mb_strlen($default_action) > 10)) {
            throw new \InvalidArgumentException('invalid length for $default_action when calling OutgoingDdiRuleDetailed., must be smaller than or equal to 10.');
        }
