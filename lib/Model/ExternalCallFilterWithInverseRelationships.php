...
/**
 * ExternalCallFilterWithInverseRelationships Class Doc Comment
 *
 * @category Class
 * @package  Delta\Voip
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalCallFilterWithInverseRelationships implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalCallFilter-withInverseRelationships';
    ...
    protected static $attributeMap = [
        ...
        'white_list_ids' => 'whiteListIds',
        'black_list_ids' => 'blackListIds'
    ];
    ...
    protected static $setters = [
        ...
        'white_list_ids' => 'setWhiteListIds',
        'black_list_ids' => 'setBlackListIds'
    ];
    ...
    protected static $getters = [
        ...
        'white_list_ids' => 'getWhiteListIds',
        'black_list_ids' => 'getBlackListIds'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['white_list_ids'] = isset($data['white_list_ids']) ? $data['white_list_ids'] : null;
        $this->container['black_list_ids'] = isset($data['black_list_ids']) ? $data['black_list_ids'] : null;
    }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ExternalCallFilterWithInverseRelationships., must be smaller than or equal to 50.');
        }
    ...
    public function setHolidayTargetType($holiday_target_type)
    {
        ...
        if (!is_null($holiday_target_type) && (mb_strlen($holiday_target_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $holiday_target_type when calling ExternalCallFilterWithInverseRelationships., must be smaller than or equal to 25.');
        }
    ...
    public function setHolidayNumberValue($holiday_number_value)
    {
        if (!is_null($holiday_number_value) && (mb_strlen($holiday_number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $holiday_number_value when calling ExternalCallFilterWithInverseRelationships., must be smaller than or equal to 25.');
        }
    ...
    public function setOutOfScheduleTargetType($out_of_schedule_target_type)
    {
        ...
        if (!is_null($out_of_schedule_target_type) && (mb_strlen($out_of_schedule_target_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $out_of_schedule_target_type when calling ExternalCallFilterWithInverseRelationships., must be smaller than or equal to 25.');
        }
    ...
    public function setOutOfScheduleNumberValue($out_of_schedule_number_value)
    {
        if (!is_null($out_of_schedule_number_value) && (mb_strlen($out_of_schedule_number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $out_of_schedule_number_value when calling ExternalCallFilterWithInverseRelationships., must be smaller than or equal to 25.');
        }
    ...
    {
        return $this->container['white_list_ids'];
    }

    /**
     * Sets white_list_ids
     *
     * @param int[] $white_list_ids Whitelisted matchlists
     *
     * @return $this
     */
    public function setWhiteListIds($white_list_ids)
    {
        $this->container['white_list_ids'] = $white_list_ids;
    ...
    {
        return $this->container['black_list_ids'];
    }

    /**
     * Sets black_list_ids
     *
     * @param int[] $black_list_ids Blacklisted matchlists
     *
     * @return $this
     */
    public function setBlackListIds($black_list_ids)
    {
        $this->container['black_list_ids'] = $black_list_ids;
