...
class Extension implements ModelInterface, ArrayAccess
{
    ...
    public function setNumber($number)
    {
        if ((mb_strlen($number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Extension., must be smaller than or equal to 10.');
        }
    ...
    public function setRouteType($route_type)
    {
        ...
        if (!is_null($route_type) && (mb_strlen($route_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $route_type when calling Extension., must be smaller than or equal to 25.');
        }
    ...
    public function setNumberValue($number_value)
    {
        if (!is_null($number_value) && (mb_strlen($number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $number_value when calling Extension., must be smaller than or equal to 25.');
        }
    ...
    public function setFriendValue($friend_value)
    {
        if (!is_null($friend_value) && (mb_strlen($friend_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $friend_value when calling Extension., must be smaller than or equal to 25.');
        }
