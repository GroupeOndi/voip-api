 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IvrEntryDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IvrEntry-detailed';
    ...
    public function setEntry($entry)
    {
        if ((mb_strlen($entry) > 40)) {
            throw new \InvalidArgumentException('invalid length for $entry when calling IvrEntryDetailed., must be smaller than or equal to 40.');
        }
    ...
    public function setRouteType($route_type)
    {
        ...
        if ((mb_strlen($route_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $route_type when calling IvrEntryDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setNumberValue($number_value)
    {
        if (!is_null($number_value) && (mb_strlen($number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $number_value when calling IvrEntryDetailed., must be smaller than or equal to 25.');
        }
