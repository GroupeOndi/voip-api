...
/**
 * MatchListPattern Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MatchListPattern implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MatchListPattern';
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 55)) {
            throw new \InvalidArgumentException('invalid length for $description when calling MatchListPattern., must be smaller than or equal to 55.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $type when calling MatchListPattern., must be smaller than or equal to 10.');
        }
    ...
    public function setRegexp($regexp)
    {
        if (!is_null($regexp) && (mb_strlen($regexp) > 255)) {
            throw new \InvalidArgumentException('invalid length for $regexp when calling MatchListPattern., must be smaller than or equal to 255.');
        }
    ...
    public function setNumbervalue($numbervalue)
    {
        if (!is_null($numbervalue) && (mb_strlen($numbervalue) > 25)) {
            throw new \InvalidArgumentException('invalid length for $numbervalue when calling MatchListPattern., must be smaller than or equal to 25.');
        }
