...
/**
 * ConditionalRouteCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConditionalRouteCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionalRoute-collection';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ConditionalRouteCollection., must be smaller than or equal to 100.');
        }
    ...
    public function setRoutetype($routetype)
    {
        ...
        if (!is_null($routetype) && (mb_strlen($routetype) > 25)) {
            throw new \InvalidArgumentException('invalid length for $routetype when calling ConditionalRouteCollection., must be smaller than or equal to 25.');
        }
    ...
    public function setNumbervalue($numbervalue)
    {
        if (!is_null($numbervalue) && (mb_strlen($numbervalue) > 25)) {
            throw new \InvalidArgumentException('invalid length for $numbervalue when calling ConditionalRouteCollection., must be smaller than or equal to 25.');
        }
    ...
    public function setFriendvalue($friendvalue)
    {
        if (!is_null($friendvalue) && (mb_strlen($friendvalue) > 25)) {
            throw new \InvalidArgumentException('invalid length for $friendvalue when calling ConditionalRouteCollection., must be smaller than or equal to 25.');
        }
