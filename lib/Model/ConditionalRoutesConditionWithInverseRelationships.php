...
/**
 * ConditionalRoutesConditionWithInverseRelationships Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConditionalRoutesConditionWithInverseRelationships implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionalRoutesCondition-withInverseRelationships';
    ...
    protected static $swaggerTypes = [
        ...
        'voicemail_user' => '\Swagger\Client\Model\User',
    ...
    public function setRouteType($route_type)
    {
        ...
        if (!is_null($route_type) && (mb_strlen($route_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $route_type when calling ConditionalRoutesConditionWithInverseRelationships., must be smaller than or equal to 25.');
        }
    ...
    public function setNumberValue($number_value)
    {
        if (!is_null($number_value) && (mb_strlen($number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $number_value when calling ConditionalRoutesConditionWithInverseRelationships., must be smaller than or equal to 25.');
        }
    ...
    public function setFriendValue($friend_value)
    {
        if (!is_null($friend_value) && (mb_strlen($friend_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $friend_value when calling ConditionalRoutesConditionWithInverseRelationships., must be smaller than or equal to 25.');
        }
     ...
     * Sets voicemail_user
     *
     * @param \Swagger\Client\Model\User $voicemail_user voicemail_user
     *
     * @return $this
     */
