 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallForwardSettingDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallForwardSetting-detailed';
    ...
    public function setCallTypeFilter($call_type_filter)
    {
        ...
        if ((mb_strlen($call_type_filter) > 25)) {
            throw new \InvalidArgumentException('invalid length for $call_type_filter when calling CallForwardSettingDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setCallForwardType($call_forward_type)
    {
        ...
        if ((mb_strlen($call_forward_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $call_forward_type when calling CallForwardSettingDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setTargetType($target_type)
    {
        ...
        if (!is_null($target_type) && (mb_strlen($target_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $target_type when calling CallForwardSettingDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setNumberValue($number_value)
    {
        if (!is_null($number_value) && (mb_strlen($number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $number_value when calling CallForwardSettingDetailed., must be smaller than or equal to 25.');
        }
