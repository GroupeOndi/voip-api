...
/**
 * OutgoingDdiRuleCollection Class Doc Comment
 *
 * @category Class
 * @package  Delta\Voip
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OutgoingDdiRuleCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutgoingDdiRule-collection';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OutgoingDdiRuleCollection., must be smaller than or equal to 50.');
        }
    ...
    public function setDefaultAction($default_action)
    {
        ...
        if ((mb_strlen($default_action) > 10)) {
            throw new \InvalidArgumentException('invalid length for $default_action when calling OutgoingDdiRuleCollection., must be smaller than or equal to 10.');
        }
