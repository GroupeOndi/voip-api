...
/**
 * FriendsPattern Class Doc Comment
 *
 * @category Class
 * @package  Delta\Voip
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FriendsPattern implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FriendsPattern';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FriendsPattern., must be smaller than or equal to 50.');
        }
    ...
    public function setRegExp($reg_exp)
    {
        if ((mb_strlen($reg_exp) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reg_exp when calling FriendsPattern., must be smaller than or equal to 255.');
        }
