...
/**
 * RecordingCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecordingCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Recording-collection';
    ...
    public function setCallid($callid)
    {
        if (!is_null($callid) && (mb_strlen($callid) > 255)) {
            throw new \InvalidArgumentException('invalid length for $callid when calling RecordingCollection., must be smaller than or equal to 255.');
        }
    ...
    public function setCaller($caller)
    {
        if (!is_null($caller) && (mb_strlen($caller) > 128)) {
            throw new \InvalidArgumentException('invalid length for $caller when calling RecordingCollection., must be smaller than or equal to 128.');
        }
    ...
    public function setCallee($callee)
    {
        if (!is_null($callee) && (mb_strlen($callee) > 128)) {
            throw new \InvalidArgumentException('invalid length for $callee when calling RecordingCollection., must be smaller than or equal to 128.');
        }
    ...
    public function setRecorder($recorder)
    {
        if (!is_null($recorder) && (mb_strlen($recorder) > 128)) {
            throw new \InvalidArgumentException('invalid length for $recorder when calling RecordingCollection., must be smaller than or equal to 128.');
        }
