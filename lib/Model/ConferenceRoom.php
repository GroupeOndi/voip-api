...
class ConferenceRoom implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConferenceRoom';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ConferenceRoom., must be smaller than or equal to 50.');
        }
    ...
    public function setPinCode($pin_code)
    {
        if (!is_null($pin_code) && (mb_strlen($pin_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $pin_code when calling ConferenceRoom., must be smaller than or equal to 6.');
        }
    ...
    public function setMaxMembers($max_members)
    {
        ...
        if (($max_members < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_members when calling ConferenceRoom., must be bigger than or equal to 0.');
        }
