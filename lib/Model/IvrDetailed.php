 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IvrDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ivr-detailed';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling IvrDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (($timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling IvrDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxDigits($max_digits)
    {
        ...
        if (($max_digits < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_digits when calling IvrDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setNoInputRouteType($no_input_route_type)
    {
        ...
        if (!is_null($no_input_route_type) && (mb_strlen($no_input_route_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $no_input_route_type when calling IvrDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setNoInputNumberValue($no_input_number_value)
    {
        if (!is_null($no_input_number_value) && (mb_strlen($no_input_number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $no_input_number_value when calling IvrDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setErrorRouteType($error_route_type)
    {
        ...
        if (!is_null($error_route_type) && (mb_strlen($error_route_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $error_route_type when calling IvrDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setErrorNumberValue($error_number_value)
    {
        if (!is_null($error_number_value) && (mb_strlen($error_number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $error_number_value when calling IvrDetailed., must be smaller than or equal to 25.');
        }
