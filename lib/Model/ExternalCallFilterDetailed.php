 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalCallFilterDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalCallFilter-detailed';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ExternalCallFilterDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setHolidayTargetType($holiday_target_type)
    {
        ...
        if (!is_null($holiday_target_type) && (mb_strlen($holiday_target_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $holiday_target_type when calling ExternalCallFilterDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setHolidayNumberValue($holiday_number_value)
    {
        if (!is_null($holiday_number_value) && (mb_strlen($holiday_number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $holiday_number_value when calling ExternalCallFilterDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setOutOfScheduleTargetType($out_of_schedule_target_type)
    {
        ...
        if (!is_null($out_of_schedule_target_type) && (mb_strlen($out_of_schedule_target_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $out_of_schedule_target_type when calling ExternalCallFilterDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setOutOfScheduleNumberValue($out_of_schedule_number_value)
    {
        if (!is_null($out_of_schedule_number_value) && (mb_strlen($out_of_schedule_number_value) > 25)) {
            throw new \InvalidArgumentException('invalid length for $out_of_schedule_number_value when calling ExternalCallFilterDetailed., must be smaller than or equal to 25.');
        }
